...
insert into user(first_name,last_name,email,password,balance,roles) values('tutu','toto','tutu@mail.com','$2a$10$7zqt5K1dyY6Nooyc1jiUYOyr/pC4au3QD/U/fuetRsS8oKmkOHKQi',2000,'ROLE_ADMIN');
commit;
