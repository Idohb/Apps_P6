...
CREATE TABLE IF NOT EXISTS `dbp6`.`transaction` (
  ...
  `amountTransaction` DOUBLE NOT NULL,
...
-- -----------------------------------------------------
-- Table `dbp6`.`bankAccount`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbp6`.`bankAccount` ;

CREATE TABLE IF NOT EXISTS `dbp6`.`bankAccount` (
  `idBankAccount` INT NOT NULL AUTO_INCREMENT,
  `iban` VARCHAR(45) NOT NULL,
  `amountBank` DOUBLE NOT NULL,
